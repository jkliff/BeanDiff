...
public abstract class BeanDiffer<T> {
    ...
    public final BeanDiffResult of(final T left, final T right) {
        try {
            ...
            final List<ComparableBeanProperty> properties = getProperties(bfc, "",
                    Introspector.getBeanInfo(left.getClass()), left, right);
            ...
            final Set<ComparableBeanProperty> mismatches = ImmutableSet.copyOf(Iterables.filter(properties,
                        new Predicate<ComparableBeanProperty>() {
                            public boolean apply(final ComparableBeanProperty cbp) {
    ...
    private List<ComparableBeanProperty> getProperties(final BeanFieldComparator comparator, final String path,
            final BeanInfo beanInfo, final Object left, final Object right) throws IntrospectionException,
     ...
     */
    private List<ComparableBeanProperty> getPropertiesInternal(final BeanFieldComparator comparator, final String path,
            final BeanInfo beanInfo, final Object left, final Object right) throws IllegalAccessException,
        ...
        if (left instanceof Iterable) {
            ...
            final Iterable<?> leftIterable = (Iterable<?>) left;
            final Iterable<?> rightIterable = (Iterable<?>) right;
            ...
            while (leftIterator.hasNext()) {
                ...
                final Object next2 = rightIterator.next();
